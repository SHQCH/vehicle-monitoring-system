...
@Entity  // map this Location obj. to db table
public class Location {
    ...
    @GeneratedValue
    private Long id;
    @Embedded   // Embeded: mapping the inner class obj, to columns, flatten the class into columns.
    ...
    // map into columns with name"unit_fmi" and "unit_spn"
