 ...
 *
 * Sink: Spring predefined interface for input channel, Sink.INPUT= name of input channel
 *
 */
@MessageEndpoint
...
public class FleetLocationUpdaterSink {
	...
	@ServiceActivator(inputChannel = Sink.INPUT) // activate the service when there is event from the channel INPUT
